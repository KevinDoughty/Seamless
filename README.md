...
This gives a nice elastic wobble and is based on math from Matt Gallager's excellent Animation Acceleration project:
(http://www.cocoawithlove.com/2008/09/parametric-acceleration-curves-in-core.html)

```objc
[CATransaction setAnimationDuration:3.0];
[CATransaction setSeamlessTimingBlock:^ (CGFloat progress) {
	CGFloat omega = 20.0;
	CGFloat zeta = 0.5;
	CGFloat beta = sqrt(1.0 - zeta * zeta);
